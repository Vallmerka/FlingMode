...
function lib:init(ti, dosplash, visiblekey, deleteprevious)
    ...
    main.BackgroundColor3 = Color3.fromRGB(54, 26, 39)
    ...
    workarea.BackgroundColor3 = Color3.fromRGB(34, 31, 33)
    workarea.BackgroundTransparency = 0.20000000298023224
    ...
    workareacornerhider.BackgroundColor3 = Color3.fromRGB(34, 31, 33)
    workareacornerhider.BackgroundTransparency = 4
    ...
    search.Name = "search"
    search.Parent = main
    search.BackgroundColor3 = Color3.fromRGB(48, 46, 48)
    ...
    function window:Divider(name)
        ...
        sidebardivider.TextColor3 = Color3.fromRGB(208, 169, 212)
    ...
    function window:Section(name)
        ...
        function sec:Switch(name, defaultmode, callback)
            ...
            toggleswitch.TextColor3 = Color3.fromRGB(208, 169, 212)
